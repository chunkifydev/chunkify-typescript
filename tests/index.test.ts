...
import { APIPromise } from '@chunkify/chunkify/core/api-promise';

import util from 'node:util';
import Chunkify from '@chunkify/chunkify';
import { APIUserAbortError } from '@chunkify/chunkify';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['CHUNKIFY_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Chunkify) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['CHUNKIFY_BASE_URL'] = undefined;
    });
